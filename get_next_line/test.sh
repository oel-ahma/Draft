...
cd $(dirname $0)
gcc -Wall -Werror -Wextra -D BUFFER_SIZE=128 main1.c get_next_line_utils.c get_next_line.c -o a.out || (echo COMPILATION FAILED && exit 1)
echo ">>>>>>>>>>> Read main1.c"
...
gcc -Wall -Werror -Wextra main2.c get_next_line_utils.c get_next_line.c -o a.out
